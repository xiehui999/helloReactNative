...
export default class DecayDemo extends Component {
    constructor(props) {
        super(props);
    ...
    _resetState=()=> {
        console.log("this.state.pan",this.state)
        this.state.pan.setValue({x: 0, y: 0});
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Animated.View
                    style={[styles.card, animatedCardStyles, {backgroundColor: this.state.person}]} {...this._panResponder.panHandlers}>
                </Animated.View>
